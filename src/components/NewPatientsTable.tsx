...
export function NewPatientsTable() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-gray-900 mb-2">New Patients - Authorization Needed</h2>
        <p className="text-gray-600 text-sm">Complete authorization forms for newly scheduled patients</p>
      </div>
